    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            If Not PictureBox1.Visible And Not PictureBox2.Visible And Not PictureBox3.Visible Then
                If MsgBox("Voullez-vous supprimer le compte ?", 4, "Suppression") = MsgBoxResult.Yes Then
                    compte.Supprimer(TextBox1.Text)
                    CompteAffichage.CompteAffichage_Load(Nothing, Nothing)
                    If MsgBox("Le compte a été supprimé", 0, "Confirmation") = MsgBoxResult.Ok Then
                        Me.Close()
                    End If
                End If
            Else
