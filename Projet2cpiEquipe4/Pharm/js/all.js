...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Aide Pharma","1. Aide PHARMA","Vente","Commande","Achat","Restitution","Pharmacies","Comptes","Statistiques","Démarrage","Vente au comptoir","Journal de vente","Facturation"],
    DREX_NODE_LINKS: ["aide_pharma_1.htm","aide_pharma_2.htm","vente.htm","commande.htm","achat.htm","restitution.htm","pharmacies.htm","comptes.htm","statistiques.htm","demarrage.htm","vente_au_comptoir.htm","journal_de_vente.htm","facturation.htm"],
    DREX_NODE_CHILD_START: [1,2,10,13,13,13,13,13,13,13,13,13,13],
    DREX_NODE_CHILD_END: [2,10,13,13,13,13,13,13,13,13,13,13,13],
    DREX_MENU_TYPE: 2,
